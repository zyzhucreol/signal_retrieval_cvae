...
from Hologram.forward_model import A_fun, AT_fun
...
args.learning_rate=1e-5 # learning rate for optimizer
...
# file I/O parameters
load_model=True
save_name='PIAE_hologram_1021'
save_model_path='./models/'+save_name # path to save trained model
load_model_path='./models/PIAE_hologram_1021' # path to load pre-trained weights, if load_model=True
...
y_backprop = AT_fun(y)
y_backprop = tf.reshape(y_backprop,(-1,args.N_det,args.N_det,1))
ry = cond_prior_encode(y_backprop)
